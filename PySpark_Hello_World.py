...
with mlflow.start_run(run_name='untuned_random_forest', experiment_id=experiment.experiment_id):
  n_estimators = 10
...
#with mlflow.start_run(run_name='xgboost_models', experiment_id=experiment.experiment_id):
#  best_params = fmin(
#    fn=train_model, 
#    space=search_space, 
#    algo=tpe.suggest, 
...
# MAGIC %sh 
# MAGIC 
# MAGIC ls /dbfs/administration/Model_Data/PySpark_Hello_World/
...
#table_path = "dbfs:/Tamara.Normile@peraton.com/delta/wine_data"
folder_name = "PySpark_Hello_World"
table_path = "dbfs:/administration/Model_Data/" + folder_name
...
import os
os.environ["DATABRICKS_TOKEN"] = "dapi9a91ed3dd91eb731971528bc41986338"
...
def score_model(dataset: pd.DataFrame):
  url = 'https://dbc-25588e62-6b8e.cloud.databricks.com/model/wine_quality/Production/invocations'
...
# MAGIC %md
# MAGIC 
# MAGIC ##MLflow Metrics & Images
# MAGIC 
# MAGIC <img src="/files/shared_uploads/newplot.png">
# MAGIC <img src="/files/shared_uploads/newplot1.png">
# MAGIC <img src="/files/shared_uploads/newplot2.png">
# MAGIC <img src="https://raw.githubusercontent.com/tamaranor91/poc_work/main/databricks_work/fraud_models/newplot.png">